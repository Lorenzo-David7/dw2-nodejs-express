...
router.get("/clientes",function(req,res){
    ...
    // Aqui vamos chamar o model "Cliente", invocar o método finAll() para buscar todos os registros da tabela de cliente    
    Clinte.findAll().then(clientes => {
        res.render("clientes", {
            clientes : clientes
        })
    }).catch(error => {
        console.log("Ocorreu um erro ao buscar os clinetes." + error)
    });
